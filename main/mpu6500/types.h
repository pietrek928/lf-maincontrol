...
static constexpr mot_stat_t MOT_STAT_XNEG       = (1 << MOT_STATUS_X_NEG_BIT);
static constexpr mot_stat_t MOT_STAT_XPOS       = (1 << MOT_STATUS_X_POS_BIT);
static constexpr mot_stat_t MOT_STAT_YNEG       = (1 << MOT_STATUS_Y_NEG_BIT);
static constexpr mot_stat_t MOT_STAT_YPOS       = (1 << MOT_STATUS_Y_POS_BIT);
static constexpr mot_stat_t MOT_STAT_ZNEG       = (1 << MOT_STATUS_Z_NEG_BIT);
static constexpr mot_stat_t MOT_STAT_ZPOS       = (1 << MOT_STATUS_Z_POS_BIT);
static constexpr mot_stat_t MOT_STAT_ZEROMOTION = (1 << MOT_STATUS_ZRMOT_BIT);
#endif

/*! Standby Mode */
typedef uint8_t stby_en_t;
static constexpr stby_en_t STBY_EN_NONE    = (0x0);
static constexpr stby_en_t STBY_EN_ACCEL_X = (1 << PWR2_STBY_XA_BIT);
static constexpr stby_en_t STBY_EN_ACCEL_Y = (1 << PWR2_STBY_YA_BIT);
static constexpr stby_en_t STBY_EN_ACCEL_Z = (1 << PWR2_STBY_ZA_BIT);
static constexpr stby_en_t STBY_EN_ACCEL   = (STBY_EN_ACCEL_X | STBY_EN_ACCEL_Y | STBY_EN_ACCEL_Z);
static constexpr stby_en_t STBY_EN_GYRO_X  = (1 << PWR2_STBY_XG_BIT);
static constexpr stby_en_t STBY_EN_GYRO_Y  = (1 << PWR2_STBY_YG_BIT);
static constexpr stby_en_t STBY_EN_GYRO_Z  = (1 << PWR2_STBY_ZG_BIT);
...
static constexpr auxi2c_stat_t AUXI2C_STAT_FSYNC     = (1 << I2CMST_STAT_PASS_THROUGH_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_LOST_ARB  = (1 << I2CMST_STAT_LOST_ARB_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_SLV4_DONE = (1 << I2CMST_STAT_SLV4_DONE_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_SLV4_NACK = (1 << I2CMST_STAT_SLV4_NACK_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_SLV3_NACK = (1 << I2CMST_STAT_SLV3_NACK_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_SLV2_NACK = (1 << I2CMST_STAT_SLV2_NACK_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_SLV1_NACK = (1 << I2CMST_STAT_SLV1_NACK_BIT);
static constexpr auxi2c_stat_t AUXI2C_STAT_SLV0_NACK = (1 << I2CMST_STAT_SLV0_NACK_BIT);
...
static constexpr int_en_t INT_EN_MOTION_DETECT = (1 << INT_ENABLE_MOTION_BIT);
static constexpr int_en_t INT_EN_FIFO_OVERFLOW = (1 << INT_ENABLE_FIFO_OFLOW_BIT);
static constexpr int_en_t INT_EN_I2C_MST_FSYNC = (1 << INT_ENABLE_I2C_MST_FSYNC_BIT);  // int from I2C_MST_STATUS
static constexpr int_en_t INT_EN_PLL_READY     = (1 << INT_ENABLE_PLL_RDY_BIT);
static constexpr int_en_t INT_EN_DMP_READY     = (1 << INT_ENABLE_DMP_RDY_BIT);
static constexpr int_en_t INT_EN_RAWDATA_READY = (1 << INT_ENABLE_RAW_DATA_RDY_BIT);
#if defined CONFIG_MPU6000 || defined CONFIG_MPU6050 || defined CONFIG_MPU9150
static constexpr int_en_t INT_EN_FREE_FALL   = (1 << INT_ENABLE_FREEFALL_BIT);
static constexpr int_en_t INT_EN_ZERO_MOTION = (1 << INT_ENABLE_ZEROMOT_BIT);
#endif
...
static constexpr int_stat_t INT_STAT_MOTION_DETECT = (1 << INT_STATUS_MOTION_BIT);
static constexpr int_stat_t INT_STAT_FIFO_OVERFLOW = (1 << INT_STATUS_FIFO_OFLOW_BIT);
static constexpr int_stat_t INT_STAT_I2C_MST_FSYNC = (1 << INT_STATUS_I2C_MST_BIT);  // int from I2C_MST_STATUS
static constexpr int_stat_t INT_STAT_PLL_READY     = (1 << INT_STATUS_PLL_RDY_BIT);
static constexpr int_stat_t INT_STAT_DMP_READY     = (1 << INT_STATUS_DMP_RDY_BIT);
static constexpr int_stat_t INT_STAT_RAWDATA_READY = (1 << INT_STATUS_RAW_DATA_RDY_BIT);
#if defined CONFIG_MPU6000 || defined CONFIG_MPU6050 || defined CONFIG_MPU9150
static constexpr int_stat_t INT_STAT_FREE_FALL   = (1 << INT_STATUS_FREEFALL_BIT);
static constexpr int_stat_t INT_STAT_ZERO_MOTION = (1 << INT_STATUS_ZEROMOT_BIT);
#endif
...
static constexpr fifo_config_t FIFO_CFG_ACCEL       = (1 << FIFO_ACCEL_EN_BIT);
static constexpr fifo_config_t FIFO_CFG_TEMPERATURE = (1 << FIFO_TEMP_EN_BIT);
static constexpr fifo_config_t FIFO_CFG_SLAVE0      = (1 << FIFO_SLV_0_EN_BIT);
static constexpr fifo_config_t FIFO_CFG_SLAVE1      = (1 << FIFO_SLV_1_EN_BIT);
static constexpr fifo_config_t FIFO_CFG_SLAVE2      = (1 << FIFO_SLV_2_EN_BIT);
